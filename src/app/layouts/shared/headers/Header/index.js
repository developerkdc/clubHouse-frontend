...
const Header = () => {
  ...
  return (
    <React.Fragment>
      ...
      {sidebarOptions?.style === SIDEBAR_STYLES.CLIPPED_UNDER_HEADER && <Logo sx={{ }} mode={headerTheme.type ?? "light"} />}
      {/* {
                showDropdownSearch &&
      ...
      <Stack direction="row" alignItems="center" spacing={1.25} sx={{ ml: "auto", zIndex: "10" }}>
        {showDropdownSearch && (
